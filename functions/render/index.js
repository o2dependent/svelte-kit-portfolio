...
var css$4 = {
  code: ".__layout.svelte-zp79rh{display:flex;width:100vw;min-height:100vh}@media screen and (max-width: 768px){.__layout.svelte-zp79rh{flex-direction:column}}main.svelte-zp79rh{background-color:var(--secondary-color);box-shadow:inset 0 0 5px #00000040;flex:1;display:flex;padding:1rem;width:100%;box-sizing:border-box;padding-top:28px}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script lang=\\"ts\\">import AboutProfile from '$lib/AboutProfile/index.svelte';\\nimport '../app.css';\\n<\/script>\\n\\n<div class=\\"__layout\\">\\n\\t<AboutProfile />\\n\\t<main>\\n\\t\\t<slot />\\n\\t</main>\\n</div>\\n\\n<style>\\n\\t.__layout {\\n\\t\\tdisplay: flex;\\n\\t\\twidth: 100vw;\\n\\t\\tmin-height: 100vh;\\n\\t}\\n\\t@media screen and (max-width: 768px) {\\n\\t\\t.__layout {\\n\\t\\t\\tflex-direction: column;\\n\\t\\t}\\n\\t}\\n\\n\\tmain {\\n\\t\\tbackground-color: var(--secondary-color);\\n\\t\\tbox-shadow: inset 0 0 5px #00000040;\\n\\t\\tflex: 1;\\n\\t\\tdisplay: flex;\\n\\t\\tpadding: 1rem;\\n\\t\\twidth: 100%;\\n\\t\\tbox-sizing: border-box;\\n\\t\\tpadding-top: 28px;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAYC,SAAS,cAAC,CAAC,AACV,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,KAAK,CACZ,UAAU,CAAE,KAAK,AAClB,CAAC,AACD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACrC,SAAS,cAAC,CAAC,AACV,cAAc,CAAE,MAAM,AACvB,CAAC,AACF,CAAC,AAED,IAAI,cAAC,CAAC,AACL,gBAAgB,CAAE,IAAI,iBAAiB,CAAC,CACxC,UAAU,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,SAAS,CACnC,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,UAAU,CACtB,WAAW,CAAE,IAAI,AAClB,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$4);
  return `<div class="${"__layout svelte-zp79rh"}">${validate_component(AboutProfile, "AboutProfile").$$render($$result, {}, {}, {})}
	<main class="${"svelte-zp79rh"}">${slots.default ? slots.default({}) : ``}</main>
</div>`;
});
...
${validate_component(Masonry, "Masonry").$$render($$result, {
      ...
      default: () => `${each(cards, (card) => `<div class="${"card svelte-1kkyjf9"}"><img${add_attribute("src", card.img.src(Math.floor(Math.random() * 350 + 350), Math.floor(Math.random() * 350 + 350)), 0)}${add_attribute("alt", card.img.alt, 0)} class="${"svelte-1kkyjf9"}">
			<div class="${"card__body svelte-1kkyjf9"}"><strong class="${"svelte-1kkyjf9"}">${escape2(card.title)}</strong>
				<p class="${"svelte-1kkyjf9"}">${escape2(card.body)}</p></div>
		</div>`)}`
    })}`;
  } while (!$$settled);
  return $$rendered;
