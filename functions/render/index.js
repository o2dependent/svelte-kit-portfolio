...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-33489f93.js",
      css: ["/./_app/assets/start-a8cd1609.css", "/./_app/assets/vendor-436f133f.css"],
      js: ["/./_app/start-33489f93.js", "/./_app/chunks/vendor-5531500b.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-5a3f3940.js", "css": ["/./_app/assets/pages/__layout.svelte-15bab727.css", "/./_app/assets/vendor-436f133f.css"], "js": ["/./_app/pages/__layout.svelte-5a3f3940.js", "/./_app/chunks/vendor-5531500b.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-1f1fee08.js", "css": ["/./_app/assets/vendor-436f133f.css"], "js": ["/./_app/error.svelte-1f1fee08.js", "/./_app/chunks/vendor-5531500b.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-f7a30524.js", "css": ["/./_app/assets/pages/index.svelte-132511bb.css", "/./_app/assets/vendor-436f133f.css"], "js": ["/./_app/pages/index.svelte-f7a30524.js", "/./_app/chunks/vendor-5531500b.js"], "styles": null }, "src/routes/about.svelte": { "entry": "/./_app/pages/about.svelte-65c8f700.js", "css": ["/./_app/assets/pages/about.svelte-0cd840a0.css", "/./_app/assets/vendor-436f133f.css"], "js": ["/./_app/pages/about.svelte-65c8f700.js", "/./_app/chunks/vendor-5531500b.js"], "styles": null } };
...
var css$3 = {
  code: "body{max-width:100vw}.__layout.svelte-gjdlyo{display:flex;width:100vw;min-height:100vh}@media screen and (max-width: 768px){.__layout.svelte-gjdlyo{flex-direction:column}}.profile-panel.svelte-gjdlyo{background-color:var(--tertiary-color);width:350px;max-width:100vw;min-height:100vh;height:100%;padding:2rem;padding-top:28px;display:flex;flex-direction:column;gap:0.5rem;position:sticky;top:0}.profile-panel.mobile.svelte-gjdlyo{display:none}.mobile-nav.svelte-gjdlyo{display:none}@media screen and (max-width: 768px){.profile-panel.mobile.svelte-gjdlyo{display:flex}.profile-panel.desktop.svelte-gjdlyo{display:none}.profile-panel.svelte-gjdlyo{z-index:999}.mobile-nav.svelte-gjdlyo{all:unset;z-index:9999;cursor:pointer;border-radius:9999px;display:flex;justify-content:center;align-items:center;position:fixed;bottom:0.5rem;right:0.5rem;height:3rem;width:3rem;background-color:var(--tertiary-color);box-shadow:0 0 5px #00000040}.profile-panel.svelte-gjdlyo{position:fixed;left:0;transition:left 300ms ease-out;box-shadow:0 0 3px #00000040}}main.svelte-gjdlyo{background-color:var(--secondary-color);transition:transform 500ms ease-out;box-shadow:inset 0 0 5px #00000040;flex:1;display:flex;padding:1rem;width:100%;box-sizing:border-box;padding-top:28px;position:relative}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script lang=\\"ts\\">import AboutProfile from '$lib/AboutProfile/index.svelte';\\nimport '../app.css';\\nimport { fly } from 'svelte/transition';\\nimport { circOut } from 'svelte/easing';\\nimport { drawerStore } from '../stores/drawerStore';\\nimport { onMount } from 'svelte';\\nlet isDrawerOpen;\\ndrawerStore.subscribe((val) => {\\n    isDrawerOpen = val;\\n});\\nconst toggleDrawer = (val) => {\\n    if (typeof val === 'undefined') {\\n        drawerStore.update(() => !isDrawerOpen);\\n    }\\n    else {\\n        drawerStore.update(() => val);\\n    }\\n};\\nlet toggleScroll = (isDrawerOpen) => null;\\nonMount(() => {\\n    toggleScroll = (isDrawerOpen) => (document.body.style.overflowY = isDrawerOpen ? 'hidden' : '');\\n});\\n$: toggleScroll(isDrawerOpen);\\n<\/script>\\n\\n<div class=\\"__layout\\">\\n\\t<!-- mobile FAB -->\\n\\t<button class=\\"mobile-nav\\" on:click={() => toggleDrawer()}\\n\\t\\t><svg\\n\\t\\t\\txmlns=\\"http://www.w3.org/2000/svg\\"\\n\\t\\t\\twidth=\\"50%\\"\\n\\t\\t\\theight=\\"50%\\"\\n\\t\\t\\tfill-rule=\\"evenodd\\"\\n\\t\\t\\tclip-rule=\\"evenodd\\"\\n\\t\\t\\t><path d=\\"M24 18v1h-24v-1h24zm0-6v1h-24v-1h24zm0-6v1h-24v-1h24z\\" fill=\\"#1040e2\\" /><path\\n\\t\\t\\t\\td=\\"M24 19h-24v-1h24v1zm0-6h-24v-1h24v1zm0-6h-24v-1h24v1z\\"\\n\\t\\t\\t/></svg\\n\\t\\t>\\n\\t</button>\\n\\n\\t<!-- drawer mobile -->\\n\\t{#if isDrawerOpen}\\n\\t\\t<div transition:fly={{ x: -400, easing: circOut }} class=\\"profile-panel mobile\\">\\n\\t\\t\\t<AboutProfile />\\n\\t\\t</div>\\n\\t{/if}\\n\\t<!-- drawer desktop -->\\n\\t<div class=\\"profile-panel desktop\\">\\n\\t\\t<AboutProfile />\\n\\t</div>\\n\\n\\t<!-- route slot -->\\n\\t<main>\\n\\t\\t<slot />\\n\\t</main>\\n</div>\\n\\n<style>\\n\\t:global(body) {\\n\\t\\tmax-width: 100vw;\\n\\t}\\n\\t.__layout {\\n\\t\\tdisplay: flex;\\n\\t\\twidth: 100vw;\\n\\t\\tmin-height: 100vh;\\n\\t}\\n\\t@media screen and (max-width: 768px) {\\n\\t\\t.__layout {\\n\\t\\t\\tflex-direction: column;\\n\\t\\t}\\n\\t}\\n\\n\\t.profile-panel {\\n\\t\\tbackground-color: var(--tertiary-color);\\n\\t\\twidth: 350px;\\n\\t\\tmax-width: 100vw;\\n\\t\\tmin-height: 100vh;\\n\\t\\theight: 100%;\\n\\t\\tpadding: 2rem;\\n\\t\\tpadding-top: 28px;\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tgap: 0.5rem;\\n\\t\\tposition: sticky;\\n\\t\\ttop: 0;\\n\\t}\\n\\t.profile-panel.mobile {\\n\\t\\tdisplay: none;\\n\\t}\\n\\t.mobile-nav {\\n\\t\\tdisplay: none;\\n\\t}\\n\\t@media screen and (max-width: 768px) {\\n\\t\\t.profile-panel.mobile {\\n\\t\\t\\tdisplay: flex;\\n\\t\\t}\\n\\t\\t.profile-panel.desktop {\\n\\t\\t\\tdisplay: none;\\n\\t\\t}\\n\\n\\t\\t.profile-panel {\\n\\t\\t\\tz-index: 999;\\n\\t\\t}\\n\\t\\t.mobile-nav {\\n\\t\\t\\tall: unset;\\n\\t\\t\\tz-index: 9999;\\n\\t\\t\\tcursor: pointer;\\n\\t\\t\\tborder-radius: 9999px;\\n\\t\\t\\tdisplay: flex;\\n\\t\\t\\tjustify-content: center;\\n\\t\\t\\talign-items: center;\\n\\t\\t\\tposition: fixed;\\n\\t\\t\\tbottom: 0.5rem;\\n\\t\\t\\tright: 0.5rem;\\n\\t\\t\\theight: 3rem;\\n\\t\\t\\twidth: 3rem;\\n\\t\\t\\tbackground-color: var(--tertiary-color);\\n\\t\\t\\tbox-shadow: 0 0 5px #00000040;\\n\\t\\t}\\n\\n\\t\\t.profile-panel {\\n\\t\\t\\tposition: fixed;\\n\\t\\t\\tleft: 0;\\n\\t\\t\\ttransition: left 300ms ease-out;\\n\\t\\t\\tbox-shadow: 0 0 3px #00000040;\\n\\t\\t}\\n\\t}\\n\\n\\tmain {\\n\\t\\tbackground-color: var(--secondary-color);\\n\\t\\ttransition: transform 500ms ease-out;\\n\\t\\tbox-shadow: inset 0 0 5px #00000040;\\n\\t\\tflex: 1;\\n\\t\\tdisplay: flex;\\n\\t\\tpadding: 1rem;\\n\\t\\twidth: 100%;\\n\\t\\tbox-sizing: border-box;\\n\\t\\tpadding-top: 28px;\\n\\t\\tposition: relative;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA0DS,IAAI,AAAE,CAAC,AACd,SAAS,CAAE,KAAK,AACjB,CAAC,AACD,SAAS,cAAC,CAAC,AACV,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,KAAK,CACZ,UAAU,CAAE,KAAK,AAClB,CAAC,AACD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACrC,SAAS,cAAC,CAAC,AACV,cAAc,CAAE,MAAM,AACvB,CAAC,AACF,CAAC,AAED,cAAc,cAAC,CAAC,AACf,gBAAgB,CAAE,IAAI,gBAAgB,CAAC,CACvC,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,IAAI,CACjB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,MAAM,CACX,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,CAAC,AACP,CAAC,AACD,cAAc,OAAO,cAAC,CAAC,AACtB,OAAO,CAAE,IAAI,AACd,CAAC,AACD,WAAW,cAAC,CAAC,AACZ,OAAO,CAAE,IAAI,AACd,CAAC,AACD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACrC,cAAc,OAAO,cAAC,CAAC,AACtB,OAAO,CAAE,IAAI,AACd,CAAC,AACD,cAAc,QAAQ,cAAC,CAAC,AACvB,OAAO,CAAE,IAAI,AACd,CAAC,AAED,cAAc,cAAC,CAAC,AACf,OAAO,CAAE,GAAG,AACb,CAAC,AACD,WAAW,cAAC,CAAC,AACZ,GAAG,CAAE,KAAK,CACV,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,OAAO,CACf,aAAa,CAAE,MAAM,CACrB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,KAAK,CACf,MAAM,CAAE,MAAM,CACd,KAAK,CAAE,MAAM,CACb,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,IAAI,gBAAgB,CAAC,CACvC,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,SAAS,AAC9B,CAAC,AAED,cAAc,cAAC,CAAC,AACf,QAAQ,CAAE,KAAK,CACf,IAAI,CAAE,CAAC,CACP,UAAU,CAAE,IAAI,CAAC,KAAK,CAAC,QAAQ,CAC/B,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,SAAS,AAC9B,CAAC,AACF,CAAC,AAED,IAAI,cAAC,CAAC,AACL,gBAAgB,CAAE,IAAI,iBAAiB,CAAC,CACxC,UAAU,CAAE,SAAS,CAAC,KAAK,CAAC,QAAQ,CACpC,UAAU,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,SAAS,CACnC,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,UAAU,CACtB,WAAW,CAAE,IAAI,CACjB,QAAQ,CAAE,QAAQ,AACnB,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"__layout svelte-gjdlyo"}">
	<button class="${"mobile-nav svelte-gjdlyo"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" width="${"50%"}" height="${"50%"}" fill-rule="${"evenodd"}" clip-rule="${"evenodd"}"><path d="${"M24 18v1h-24v-1h24zm0-6v1h-24v-1h24zm0-6v1h-24v-1h24z"}" fill="${"#1040e2"}"></path><path d="${"M24 19h-24v-1h24v1zm0-6h-24v-1h24v1zm0-6h-24v-1h24v1z"}"></path></svg></button>

	
	${isDrawerOpen ? `<div class="${"profile-panel mobile svelte-gjdlyo"}">${validate_component(AboutProfile, "AboutProfile").$$render($$result, {}, {}, {})}</div>` : ``}
	
	<div class="${"profile-panel desktop svelte-gjdlyo"}">${validate_component(AboutProfile, "AboutProfile").$$render($$result, {}, {}, {})}</div>

	
	<main class="${"svelte-gjdlyo"}">${slots.default ? slots.default({}) : ``}</main>
</div>`;
});
...
var images = [
  "https://www.datocms-assets.com/49829/1624077689-pxl20210507015559997.jpg",
...
var cards = new Array(10).fill(null).map((x, idx) => ({
  id: idx,
  title: `Title ${idx}`,
...
var css$1 = {
  code: ".card.svelte-573ew7.svelte-573ew7{width:100%;background-color:white;box-shadow:0 0 5px #00000040;position:relative}.card__body.svelte-573ew7.svelte-573ew7{padding:1.25rem}.card.svelte-573ew7 img.svelte-573ew7{width:100%}strong.svelte-573ew7.svelte-573ew7{margin:0}.card.svelte-573ew7 p.svelte-573ew7{margin:0;margin-top:0.5rem;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;text-overflow:ellipsis}.zoom.svelte-573ew7.svelte-573ew7{position:absolute;top:0;right:0;padding:0.5rem;border-bottom-left-radius:16px;background-color:var(--secondary-color);box-shadow:inset 0 0 5px #00000020;cursor:pointer}.img-container.svelte-573ew7.svelte-573ew7{position:relative}.img-shadow.svelte-573ew7.svelte-573ew7{position:absolute;top:0;left:0;width:100%;height:100%;z-index:-10}.photo.svelte-573ew7.svelte-573ew7{z-index:9999;background-color:#00000040;position:fixed;top:0;left:0;width:100%;height:100%;display:flex;align-items:center;justify-content:center;flex-direction:column;will-change:transform;overflow:hidden}.photo.svelte-573ew7 img.svelte-573ew7{cursor:default;box-shadow:0 0 10px #00000080;max-width:100vw;max-height:100vh}img.svelte-573ew7.svelte-573ew7{object-fit:cover;cursor:pointer}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script context=\\"module\\" lang=\\"ts\\">import Masonry from 'svelte-masonry/Masonry.svelte';\\nexport const prerender = true;\\nlet refreshLayout;\\n<\/script>\\n\\n<script lang=\\"ts\\">import cards from '../dummydata/cards';\\nimport { crossfade, fade, scale } from 'svelte/transition';\\nconst [send, receive] = crossfade({\\n    duration: 700,\\n    fallback: scale\\n});\\n/**\\n * Preview photo handlers\\n */\\nlet selected = null;\\nlet loading = null;\\nconst load = (image) => {\\n    loading = image;\\n    const img = new Image();\\n    img.onload = () => {\\n        selected = image;\\n        loading = null;\\n    };\\n    img.src = image.img.src;\\n};\\n<\/script>\\n\\n<svelte:head>\\n\\t<title>Home</title>\\n</svelte:head>\\n\\n<Masonry bind:refreshLayout gridGap={'0.75rem'} colWidth={'minmax(Min(350px, 100%), 1fr)'}>\\n\\t{#each cards as card}\\n\\t\\t<div class=\\"card\\">\\n\\t\\t\\t<div class=\\"img-container\\">\\n\\t\\t\\t\\t<img\\n\\t\\t\\t\\t\\tid=\\"{card.id} \\"\\n\\t\\t\\t\\t\\ton:click={() => load(card)}\\n\\t\\t\\t\\t\\ton:load={refreshLayout}\\n\\t\\t\\t\\t\\tsrc={card.img.src}\\n\\t\\t\\t\\t\\talt={card.img.alt}\\n\\t\\t\\t\\t/>\\n\\n\\t\\t\\t\\t{#if selected?.id !== card.id}\\n\\t\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\t\\tclass=\\"img-shadow\\"\\n\\t\\t\\t\\t\\t\\tin:receive|local={{ key: card.id }}\\n\\t\\t\\t\\t\\t\\tout:send|local={{ key: card.id }}\\n\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t<div class=\\"zoom\\" on:click={() => load(card)}>\\n\\t\\t\\t\\t\\t<svg xmlns=\\"http://www.w3.org/2000/svg\\" width=\\"16\\" height=\\"16\\" viewBox=\\"0 0 24 24\\"\\n\\t\\t\\t\\t\\t\\t><path\\n\\t\\t\\t\\t\\t\\t\\td=\\"M21.172 24l-7.387-7.387c-1.388.874-3.024 1.387-4.785 1.387-4.971 0-9-4.029-9-9s4.029-9 9-9 9 4.029 9 9c0 1.761-.514 3.398-1.387 4.785l7.387 7.387-2.828 2.828zm-12.172-8c3.859 0 7-3.14 7-7s-3.141-7-7-7-7 3.14-7 7 3.141 7 7 7z\\"\\n\\t\\t\\t\\t\\t\\t/></svg\\n\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t</div>\\n\\n\\t\\t\\t<div class=\\"card__body\\">\\n\\t\\t\\t\\t<strong>{card.title}</strong>\\n\\t\\t\\t\\t<p>{card.body}</p>\\n\\t\\t\\t</div>\\n\\t\\t</div>\\n\\t{/each}\\n</Masonry>\\n\\n{#if loading || selected}\\n\\t<div in:fade out:fade class=\\"photo\\" on:click={() => (selected = null)}>\\n\\t\\t{#if selected}\\n\\t\\t\\t{#await selected then d}\\n\\t\\t\\t\\t<img in:receive={{ key: d.id }} src={d.img.src} alt={d.img.alt} />\\n\\t\\t\\t{/await}\\n\\t\\t{/if}\\n\\t</div>\\n{/if}\\n\\n<style>\\n\\t.card {\\n\\t\\twidth: 100%;\\n\\t\\tbackground-color: white;\\n\\t\\tbox-shadow: 0 0 5px #00000040;\\n\\t\\tposition: relative;\\n\\t}\\n\\n\\t.card__body {\\n\\t\\tpadding: 1.25rem;\\n\\t}\\n\\n\\t.card img {\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\tstrong {\\n\\t\\tmargin: 0;\\n\\t}\\n\\n\\t.card p {\\n\\t\\tmargin: 0;\\n\\t\\tmargin-top: 0.5rem;\\n\\t\\tdisplay: -webkit-box;\\n\\t\\t-webkit-line-clamp: 3;\\n\\t\\t-webkit-box-orient: vertical;\\n\\t\\toverflow: hidden;\\n\\t\\ttext-overflow: ellipsis;\\n\\t}\\n\\n\\t.zoom {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 0;\\n\\t\\tright: 0;\\n\\t\\tpadding: 0.5rem;\\n\\t\\tborder-bottom-left-radius: 16px;\\n\\t\\tbackground-color: var(--secondary-color);\\n\\t\\tbox-shadow: inset 0 0 5px #00000020;\\n\\t\\tcursor: pointer;\\n\\t}\\n\\n\\t/* Card image */\\n\\t.img-container {\\n\\t\\tposition: relative;\\n\\t}\\n\\t.img-shadow {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 0;\\n\\t\\tleft: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\tz-index: -10;\\n\\t}\\n\\n\\t/* Photo display */\\n\\t.photo {\\n\\t\\tz-index: 9999;\\n\\t\\tbackground-color: #00000040;\\n\\t\\tposition: fixed;\\n\\t\\ttop: 0;\\n\\t\\tleft: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t\\tflex-direction: column;\\n\\t\\twill-change: transform;\\n\\t\\toverflow: hidden;\\n\\t}\\n\\n\\t.photo img {\\n\\t\\tcursor: default;\\n\\t\\tbox-shadow: 0 0 10px #00000080;\\n\\t\\tmax-width: 100vw;\\n\\t\\tmax-height: 100vh;\\n\\t}\\n\\n\\timg {\\n\\t\\tobject-fit: cover;\\n\\t\\tcursor: pointer;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA8EC,KAAK,4BAAC,CAAC,AACN,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,KAAK,CACvB,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,SAAS,CAC7B,QAAQ,CAAE,QAAQ,AACnB,CAAC,AAED,WAAW,4BAAC,CAAC,AACZ,OAAO,CAAE,OAAO,AACjB,CAAC,AAED,mBAAK,CAAC,GAAG,cAAC,CAAC,AACV,KAAK,CAAE,IAAI,AACZ,CAAC,AAED,MAAM,4BAAC,CAAC,AACP,MAAM,CAAE,CAAC,AACV,CAAC,AAED,mBAAK,CAAC,CAAC,cAAC,CAAC,AACR,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,WAAW,CACpB,kBAAkB,CAAE,CAAC,CACrB,kBAAkB,CAAE,QAAQ,CAC5B,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,QAAQ,AACxB,CAAC,AAED,KAAK,4BAAC,CAAC,AACN,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,MAAM,CACf,yBAAyB,CAAE,IAAI,CAC/B,gBAAgB,CAAE,IAAI,iBAAiB,CAAC,CACxC,UAAU,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,SAAS,CACnC,MAAM,CAAE,OAAO,AAChB,CAAC,AAGD,cAAc,4BAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,AACnB,CAAC,AACD,WAAW,4BAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,GAAG,AACb,CAAC,AAGD,MAAM,4BAAC,CAAC,AACP,OAAO,CAAE,IAAI,CACb,gBAAgB,CAAE,SAAS,CAC3B,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,SAAS,CACtB,QAAQ,CAAE,MAAM,AACjB,CAAC,AAED,oBAAM,CAAC,GAAG,cAAC,CAAC,AACX,MAAM,CAAE,OAAO,CACf,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,SAAS,CAC9B,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,KAAK,AAClB,CAAC,AAED,GAAG,4BAAC,CAAC,AACJ,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,OAAO,AAChB,CAAC"}`
};
var prerender$1 = true;
var refreshLayout;
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  crossfade({ duration: 700, fallback: scale });
  let selected = null;
...
${validate_component(Masonry, "Masonry").$$render($$result, {
      ...
      default: () => `${each(cards, (card) => `<div class="${"card svelte-573ew7"}"><div class="${"img-container svelte-573ew7"}"><img id="${escape2(card.id) + " "}"${add_attribute("src", card.img.src, 0)}${add_attribute("alt", card.img.alt, 0)} class="${"svelte-573ew7"}">

				${(selected == null ? void 0 : selected.id) !== card.id ? `<div class="${"img-shadow svelte-573ew7"}"></div>` : ``}
				<div class="${"zoom svelte-573ew7"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" width="${"16"}" height="${"16"}" viewBox="${"0 0 24 24"}"><path d="${"M21.172 24l-7.387-7.387c-1.388.874-3.024 1.387-4.785 1.387-4.971 0-9-4.029-9-9s4.029-9 9-9 9 4.029 9 9c0 1.761-.514 3.398-1.387 4.785l7.387 7.387-2.828 2.828zm-12.172-8c3.859 0 7-3.14 7-7s-3.141-7-7-7-7 3.14-7 7 3.141 7 7 7z"}"></path></svg>
				</div></div>

			<div class="${"card__body svelte-573ew7"}"><strong class="${"svelte-573ew7"}">${escape2(card.title)}</strong>
				<p class="${"svelte-573ew7"}">${escape2(card.body)}</p></div>
		</div>`)}`
    })}
...
<div class="${"content svelte-1b2myv2"}"><h1 class="${"svelte-1b2myv2"}">About me</h1>
	...
	<p class="${"svelte-1b2myv2"}">The page illustrates SvelteKit&#39;s data loading and form handling. Try using it with JavaScript
		disabled!
	</p>
</div>`;
});
